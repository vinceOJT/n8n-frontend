...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-white selection:bg-[#FFD200] selection:text-black">
      {/* Navbar: Clean white with subtle border on scroll (optional) */}
        ...
        <div className="flex items-center justify-end w-10 md:w-32">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="text-slate-600 hover:bg-slate-100 rounded-full h-12 w-12 p-0">
      ...
      <main className="min-h-screen flex items-center justify-center pt-20 p-4 md:p-12">
        {/* Subtle background decoration (Optional) */}
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(45%_45%_at_50%_50%,#FFD200_0%,white_100%)] opacity-5" />

        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-16 relative z-10">
          
          {/* Left Text: Bold Black Typography */}
          ...
          {/* Card: Subtle Border & Depth (Replaces White-on-White Glass) */}
            ...
            <div className="bg-white border border-slate-100 rounded-[2.5rem] p-8 md:p-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)]">
              ...
              <div className="space-y-8">
                ...
                <form className="space-y-6">
                  ...
                  <Button className="w-full h-14 bg-slate-900 hover:bg-black text-white font-bold rounded-2xl shadow-lg transition-all hover:scale-[1.01] active:scale-[0.98]">
                    Generate Post
                  </Button>
                </form>
